  ...
  <div class="container">
    ...
    <ul class="nav navbar-nav">
     ...
     <form class="navbar-form navbar-left" role="search" style="display:inline;">
      ...
      <li style="display:inline;"> <input type="text" class="form-control" placeholder="খুঁজুন"> <button type="button" class="btn  btn-sm" style="color:#555 !important;"><span class="glyphicon glyphicon-search"></span></button></li>
...
<ul>
  ...
  <li><a href=" {{ route('classcategory',['class' => 'ssc' ]) }}">মাধ্যমিক</a></li>
   <li class="active"><a href=" {{ route('classcategory',['class' => 'hsc' ]) }}">উচ্চ মাধ্যমিক</a>
  ...
  <li style="float:right; margin-right:100px;"><a href="#"><span>টিউটোরিয়াল</span></a></li>
   ...
   <li style="float:right;"><a href="#"><span>আর্টিকেল ও ব্লগ</span></a></li>
      <li style="float:right;"><a href="http://localhost:8000/allquastionsort/newest"><span>প্রশ্নসম্ভার</span></a></li>
</ul>
</div>
